...
function Language() {
    const images = [
        ...
        'https://img10.hotstar.com/image/upload/f_auto,q_90,w_1920/sources/r1/cms/prod/6669/1526669-a-76efd0c306cd',
        'https://img10.hotstar.com/image/upload/f_auto,q_90,w_1920/sources/r1/cms/prod/8137/1498137-a-86c0b069edb0',
        'https://img10.hotstar.com/image/upload/f_auto,q_90,w_1920/sources/r1/cms/prod/6668/1526668-a-ed367d61302a',
        'https://img10.hotstar.com/image/upload/f_auto,q_90,w_1920/sources/r1/cms/prod/6670/1526670-a-ec8fb58a5fb8',
    ];
    ...
    return (
        <div className='pt-10 px-1' >
            <h3 className='px-2'>Populer Language</h3>
